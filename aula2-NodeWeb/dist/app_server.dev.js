...
var server = http.createServer(function (request, response) {
  ...
  var url_params = url.parse(request.url); //Vamos pegar o nome do caminho do arquivo, e salvar na variável caminho

  var caminho = url_params.pathname; //contante do nome -> __dirname (retorna o diretório de execucao do codigo)
...
var port = process.env.port || 4000; //semver.org (é uma semantica para versionamento para json package)
